...
1.  **Release the Laser Head:** Loosen the mounting screw on the carriage to allow vertical movement.
2.  **Use the Calibration Jig:** Place the focus tool between the laser head and the material. Adjust the height until the head sits perfectly flush with the tool.
...
If you have misplaced your focus tool or need specific parameters, please reach out to **Due Laser Support**.