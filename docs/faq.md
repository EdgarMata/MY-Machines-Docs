...
??? question "Where can I find the Bill of Materials (BOM) for my machine?"
...
??? question "Where can I download the STL and CAD files?"
...
??? question "What software do I need to operate these machines?"
...
??? question "Are all My Machines projects fully open-source?"
...
??? question "Can I use your machines or designs for commercial purposes?"
...
??? question "I designed a modification or improvement. How can I share it?"
...
??? question "I found a typo, documentation error, or configuration issue. How can I report it?"
...
??? question "How can I help with the overall development of My Machines?"
...
??? question "Where can I purchase the official DIY kits and hardware components?"
    While you are free to source your own parts using our open BOMs, you can purchase complete, quality-checked **DIY kits** and individual components directly from our official store at [my-machines.com](https://my-machines.com). Buying from us guarantees part compatibility, eliminates sourcing headaches, and directly supports the ongoing development of this open-source ecosystem.

??? question "Do you offer technical support if I source my own parts?"
...
??? question "How can I financially support the My Machines project?"
