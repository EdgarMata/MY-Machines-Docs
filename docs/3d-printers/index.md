...
-   ![MY-CoreXY](/assets/images/corexy.webp)
    ...
    - [:fontawesome-solid-book-open: Assembly Guide](my-corexy/manual/introduction/index.md)
    - [:fontawesome-solid-list: Bill of Materials](my-corexy/manual/bom/fasteners.md)
...
-   ![MY-Cloner](/assets/images/cloner.webp)
    ...
    - [:fontawesome-solid-book-open: Assembly Guide](my-cloner/manual/assembly-guide/01_introduction.md)
    - [:fontawesome-solid-list: Bill of Materials](my-cloner/manual/bom/mechanical-parts.md)
...
-   ![MY-Giga1M3](/assets/images/giga.webp)
    ...
    - [:fontawesome-solid-book-open: Assembly Guide](my-giga1m3/manual/assembly/frame.md)
...
-   ![MY-Mini](/assets/images/mini.webp)
    ...
    - [:fontawesome-solid-book-open: Assembly Guide](my-mini/manual/assembly-guide/index.md)
    - [:fontawesome-solid-list: Bill of Materials](my-mini/manual/bom/index.md)
...
-   ![MY-Delta](/assets/images/image-placeholder.webp)
    ...
    - [:fontawesome-solid-book-open: Assembly Guide](my-delta/assembly.md)
    - [:fontawesome-solid-download: Software](my-delta/software.md)
    - [:fontawesome-solid-wrench: Troubleshooting](my-delta/troubleshooting.md)
