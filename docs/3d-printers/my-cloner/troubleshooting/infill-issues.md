...
<figure markdown="1">
  ![Infill Issues Example](/assets/images/image-placeholder.webp#only-light){ width="600" }
  ![Infill Issues Example](/assets/images/image-placeholder.webp#only-dark){ width="600" }
