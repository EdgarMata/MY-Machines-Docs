...
<figure markdown="1">
  ![Printed part quality comparison](/assets/images/image-placeholder.webp#only-light){ width="600" }
  ![Printed part quality comparison](/assets/images/image-placeholder.webp#only-dark){ width="600" }
