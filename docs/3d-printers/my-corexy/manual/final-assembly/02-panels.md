...
!!! info "Vibration Dampening and Sealing"
...
<figure markdown="1">
  ![Applying foam tape to the frame extrusions](/assets/images/image-placeholder.webp#only-light){ width="700" }
  ![Applying foam tape to the frame extrusions](/assets/images/image-placeholder.webp#only-dark){ width="700" }
...
<figure markdown="1">
  ![Mounting a side panel with hammerhead nuts](/assets/images/image-placeholder.webp#only-light){ width="600" }
  ![Mounting a side panel with hammerhead nuts](/assets/images/image-placeholder.webp#only-dark){ width="600" }
...
<figure markdown="1">
  ...
  ![Assembling and mounting the front doors](/assets/images/image-placeholder.webp#only-dark){ width="700" }
