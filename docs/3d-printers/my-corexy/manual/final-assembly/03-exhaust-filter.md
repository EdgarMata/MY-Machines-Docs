...
<figure markdown="1">
  ![Exploded view of the exhaust filter housing](/assets/images/image-placeholder.webp#only-light){ width="600" }
  ![Exploded view of the exhaust filter housing](/assets/images/image-placeholder.webp#only-dark){ width="600" }
...
<figure markdown="1">
  ![Placing filter media into the cartridge](/assets/images/image-placeholder.webp#only-light){ width="500" }
  ![Placing filter media into the cartridge](/assets/images/image-placeholder.webp#only-dark){ width="500" }
...
<figure markdown="1">
  ![Mounting the exhaust filter assembly](/assets/images/image-placeholder.webp#only-light){ width="700" }
  ![Mounting the exhaust filter assembly](/assets/images/image-placeholder.webp#only-dark){ width="700" }
