...
<figure markdown="1">
  ![Raspberry Pi Imager Interface](/assets/images/image-placeholder.webp#only-light){ width="700" }
  ![Raspberry Pi Imager Interface](/assets/images/image-placeholder.webp#only-dark){ width="700" }
...
<figure markdown="1">
  ![Klipper make menuconfig Screen](/assets/images/image-placeholder.webp#only-light){ width="800" }
  ![Klipper make menuconfig Screen](/assets/images/image-placeholder.webp#only-dark){ width="800" }
...
<figure markdown="1">
  ![Editing the printer.cfg file](/assets/images/image-placeholder.webp#only-light){ width="800" }
  ![Editing the printer.cfg file](/assets/images/image-placeholder.webp#only-dark){ width="800" }
