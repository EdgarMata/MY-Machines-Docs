...
<figure markdown="1">
  ![Mounting the Raspberry Pi](../../../../images/image-placeholder.png#only-light){ width="500" }
  ![Mounting the Raspberry Pi](../../../../images/image-placeholder.png#only-dark){ width="500" }
...
<figure markdown="1">
  ![Mounting the 24V and 5V Power Supplies](../../../../images/image-placeholder.png#only-light){ width="700" }
  ![Mounting the 24V and 5V Power Supplies](../../../../images/image-placeholder.png#only-dark){ width="700" }
...
<figure markdown="1">
  ![Mounting the Controller Board](../../../../images/image-placeholder.png#only-light){ width="600" }
  ![Mounting the Controller Board](../../../../images/image-placeholder.png#only-dark){ width="600" }
...
<figure markdown="1">
  ![Mounting the Power Inlet and SSR](../../../../images/image-placeholder.png#only-light){ width="700" }
  ![Mounting the Power Inlet and SSR](../../../../images/image-placeholder.png#only-dark){ width="700" }
...
<figure markdown="1">
  ![Assembling the Z-Endstop](../../../../images/image-placeholder.png#only-light){ width="600" }
  ![Assembling the Z-Endstop](../../../../images/image-placeholder.png#only-dark){ width="600" }
