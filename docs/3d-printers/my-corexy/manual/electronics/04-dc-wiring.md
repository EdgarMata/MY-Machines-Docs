...
<figure markdown="1">
  ![Wiring the Z-axis motors](/assets/images/image-placeholder.webp#only-light){ width="700" }
  ![Wiring the Z-axis motors](/assets/images/image-placeholder.webp#only-dark){ width="700" }
...
<figure markdown="1">
  ![Wiring the toolhead components to the board](/assets/images/image-placeholder.webp#only-light){ width="900" }
  ![Wiring the toolhead components to the board](/assets/images/image-placeholder.webp#only-dark){ width="900" }
