...
<figure markdown="1">
  ![A hotend with a silicone sock installed](/assets/images/image-placeholder.webp#only-light){ width="400" }
  ![A hotend with a silicone sock installed](/assets/images/image-placeholder.webp#only-dark){ width="400" }
