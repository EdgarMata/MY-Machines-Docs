...
<figure markdown="1">
  ![A print showing signs of under-extrusion](/images/image-placeholder.png#only-light){ width="600" }
  ![A print showing signs of under-extrusion](/images/image-placeholder.png#only-dark){ width="600" }
