...
<figure markdown="1">
  ![A print showing signs of over-extrusion](/assets/images/image-placeholder.webp#only-light){ width="600" }
  ![A print showing signs of over-extrusion](/assets/images/image-placeholder.webp#only-dark){ width="600" }
