...
<figure markdown="1">
  ![A 3D printed part breaking along its layer lines](/assets/images/image-placeholder.webp#only-light){ width="600" }
  ![A 3D printed part breaking along its layer lines](/assets/images/image-placeholder.webp#only-dark){ width="600" }
