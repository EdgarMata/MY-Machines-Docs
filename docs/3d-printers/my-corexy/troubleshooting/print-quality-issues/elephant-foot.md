...
<figure markdown="1">
  ![The base of a 3D print showing Elephant's Foot](/assets/images/image-placeholder.webp#only-light){ width="600" }
  ![The base of a 3D print showing Elephant's Foot](/assets/images/image-placeholder.webp#only-dark){ width="600" }
