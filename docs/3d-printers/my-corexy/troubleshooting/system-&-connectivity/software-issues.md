...
<figure markdown="1">
    ![The 3D printing software toolchain](/assets/images/image-placeholder.webp#only-light){ width="600" }
    ![The 3D printing software toolchain](/assets/images/image-placeholder.webp#only-dark){ width="600" }
