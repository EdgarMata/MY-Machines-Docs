...
<figure markdown="1">
  ![A close-up of a 3D printer's Z-axis assembly](../../images/image-placeholder.png#only-light){ width="600" }
  ![A close-up of a 3D printer's Z-axis assembly](../../images/image-placeholder.png#only-dark){ width="600" }
