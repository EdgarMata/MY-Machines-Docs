...
<figure markdown="1">
  ![Overview of the A/B drive and idler components](/assets/images/image-placeholder.webp#only-light){ width="600" }
  ![Overview of the A/B drive and idler components](/assets/images/image-placeholder.webp#only-dark){ width="600" }
  <figcaption>An overview showing the four fully assembled corner components: A Drive, B Drive, A Idler, and B Idler.</figcaption>
</figure>
...
<figure markdown="1">
  ![Preparing the printed parts with inserts and nuts](/assets/images/image-placeholder.webp#only-light){ width="600" }
  ![Preparing the printed parts with inserts and nuts](/assets/images/image-placeholder.webp#only-dark){ width="600" }
  <figcaption>Various printed parts for the drives and idlers with heat-set inserts and M5 nuts being installed.</figcaption>
</figure>
...
<figure markdown="1">
  ![Exploded view of an idler assembly](/assets/images/image-placeholder.webp#only-light){ width="600" }
  ![Exploded view of an idler assembly](/assets/images/image-placeholder.webp#only-dark){ width="600" }
  <figcaption>An exploded diagram showing the components of an idler: printed body, tensioner arm, F695 bearing, shims, and screws.</figcaption>
</figure>
...
<figure markdown="1">
  ![Exploded view of a drive assembly](/assets/images/image-placeholder.webp#only-light){ width="600" }
  ![Exploded view of a drive assembly](/assets/images/image-placeholder.webp#only-dark){ width="600" }
  <figcaption>A detailed exploded diagram showing the two halves of the drive housing, the motor, pulley, and the complex bearing and shim stacks.</figcaption>
</figure>
