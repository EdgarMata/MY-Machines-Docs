...
-   :fontawesome-solid-book-open:{ .lg .middle } __Instruction Manual__
    ...
    In this section you will find everything you need about MY-CoreXY manuals as well as how to download them.

    [:octicons-arrow-right-24: Find out more](operation/introduction/index.md)

-   :fontawesome-solid-screwdriver-wrench:{ .lg .middle } __Help with maintenance__

    ---

    If you need information on how to do any type of maintenance on your MY-CoreXY, then this is the place.

    [:octicons-arrow-right-24: Find out more](maintenance/preventive-maintenance/lubrication.md)
...
-   :fontawesome-solid-helmet-safety:{ .lg .middle } __Help with saftey__
    ...
    Better safe than sorry, everything you need to about how to work safely with you MY-CoreXY.
