...
<figure markdown="1">
  ![A Pressure Advance calibration tower with measurements](/assets/images/image-placeholder.webp#only-light){ width="600" }
  ![A Pressure Advance calibration tower with measurements](/assets/images/image-placeholder.webp#only-dark){ width="600" }
