...
<figure markdown="1">
  ![Performing the paper test for Z-Offset calibration](/assets/images/image-placeholder.webp#only-light){ width="700" }
  ![Performing the paper test for Z-Offset calibration](/assets/images/image-placeholder.webp#only-dark){ width="700" }
...
<figure markdown="1">
  ![A close-up macro shot of a perfect first layer](/assets/images/image-placeholder.webp#only-light){ width="800" }
  ![A close-up macro shot of a perfect first layer](/assets/images/image-placeholder.webp#only-dark){ width="800" }
