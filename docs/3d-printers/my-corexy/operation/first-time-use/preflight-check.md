...
<figure markdown="1">
  ![Temperature graph showing heater test](/assets/images/image-placeholder.webp#only-light){ width="700" }
  ![Temperature graph showing heater test](/assets/images/image-placeholder.webp#only-dark){ width="700" }
...
<figure markdown="1">
  ![Console output from QUERY_ENDSTOPS command](/assets/images/image-placeholder.webp#only-light){ width="800" }
  ![Console output from QUERY_ENDSTOPS command](/assets/images/image-placeholder.webp#only-dark){ width="800" }
