...
<figure markdown="1">
  ![Bed mesh visualization in the web interface](/assets/images/image-placeholder.webp#only-light){ width="600" }
  ![Bed mesh visualization in the web interface](/assets/images/image-placeholder.webp#only-dark){ width="600" }
...
<figure markdown="1">
  ![Close-up of a perfect first layer](/assets/images/image-placeholder.webp#only-light){ width="700" }
  ![Close-up of a perfect first layer](/assets/images/image-placeholder.webp#only-dark){ width="700" }
...
<figure markdown="1">
  ![The finished calibration cube](/assets/images/image-placeholder.webp#only-light){ width="500" }
  ![The finished calibration cube](/assets/images/image-placeholder.webp#only-dark){ width="500" }
