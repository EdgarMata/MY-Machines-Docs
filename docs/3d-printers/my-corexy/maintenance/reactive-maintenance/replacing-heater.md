...
<figure markdown="1">
  ![Locating the heater cartridge grub screw](/assets/images/image-placeholder.webp#only-light){ width="600" }
  ![Locating the heater cartridge grub screw](/assets/images/image-placeholder.webp#only-dark){ width="600" }
