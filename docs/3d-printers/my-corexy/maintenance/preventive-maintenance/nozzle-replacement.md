...
<figure markdown="1">
  ![Removing an old nozzle while holding the heater block](/assets/images/image-placeholder.webp#only-light){ width="700" }
  ![Removing an old nozzle while holding the heater block](/assets/images/image-placeholder.webp#only-dark){ width="700" }
