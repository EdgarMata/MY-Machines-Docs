...
<figure markdown="1">
  ![Using a phone app to measure belt tension frequency](/assets/images/image-placeholder.webp#only-light){ width="700" }
  ![Using a phone app to measure belt tension frequency](/assets/images/image-placeholder.webp#only-dark){ width="700" }
