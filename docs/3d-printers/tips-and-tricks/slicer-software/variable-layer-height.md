...
<figure markdown="1">
  ![Variable Layer Height in Slicer](/assets/images/image-placeholder.webp#only-light){ width="600" }
  ![Variable Layer Height in Slicer](/assets/images/image-placeholder.webp#only-dark){ width="600" }
