...
You should check and adjust the belt tension in the following cases:
- After assembling the printer.
- If you notice print artifacts such as ghosting, layer shifts, or inconsistent dimensions.
- During regular preventive maintenance (every 3-6 months).
...
2. Use the appropriate Allen key to adjust the tension:
   ...
   - Turn counterclockwise to loosen the belt.
3. Make small adjustments and check the tension frequently.
...
2. Use the appropriate Allen key to adjust the tension:
   - Turn clockwise to tighten the belt.
   - Turn counterclockwise to loosen the belt.
3. Check the tension again after each adjustment.
...
2. Observe the print quality:
   - If you notice ghosting or layer shifts, the belts may still be too loose.
   - If the printer makes unusual noises or the motors struggle, the belts may be too tight.
3. Repeat the adjustment process if necessary.
